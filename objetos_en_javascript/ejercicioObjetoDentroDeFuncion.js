...
- Un método getStatus que devuelva el texto El canal de <name> tiene <subs> suscriptores. Por ejemplo, para
  name = 'Dani' y    subs = 100, el método getStatus devolvería El canal de Dani tiene 100 suscriptores.
...
// Validaciones
let objeto = createObject("Dani", 100);
console.log(objeto.name);
console.log(objeto.subscribers);
console.log(objeto.hash);
